...
object ClockRenderer {
    ...
    fun renderDigital(now: LocalDateTime, size: Int = 1024): Bitmap {
        ...
        drawCenteredText(canvas, "AUTO CLOCK", size / 2f, size * 0.78f, brandPaint)
    ...
    fun renderAnalog(now: LocalDateTime, size: Int = 1024): Bitmap {
        ...
        canvas.drawCircle(center, center, size * 0.018f, pinPaint)
